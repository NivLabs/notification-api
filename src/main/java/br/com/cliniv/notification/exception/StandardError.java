...
public class StandardError implements Serializable {
	...
	public StandardError(Long timestamp, int status, String error, List<ErrorItem> validations, String message,
			String path) {
		super();
	...
	public String toString() {
		return "StandardErrorSpring [timestamp=" + timestamp + ", status=" + status + ", error=" + error
				+ ", validations=" + validations + ", message=" + message + ", path=" + path + "]";
	}
